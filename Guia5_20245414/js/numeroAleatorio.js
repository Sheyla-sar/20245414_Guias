...
function generarNumeroAleatorio(){
    ...
    if (intentos <= numeroIntentos){
        ...
        if (numero == numeroAleatorio) {
            ...
            mensaje = `Su numero de intentos ha termiinado.
            El numero oculto era: ${numeroAleatorio}. Refresque la pagina para volver a jugar.`;
        } else {
            if (numero < numeroAleatorio) {
                mensaje = `El número a adivinar es más alto. Quedan ${numeroIntentos - intentos} intentos.`;
            } else {
                mensaje = `El número a adivinar es más bajo. Quedan ${numeroIntentos - intentos} intentos.`;
            }
        }
